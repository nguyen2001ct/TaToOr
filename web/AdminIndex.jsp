                                        ...
                                        <c:forEach var="show" items="${user}">
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <div class="flex items-center text-sm">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                                                <c:if var="neu" test="${show.loai==1}">Quản Trị Viên</c:if>
                                                                <c:if var="neu" test="${show.loai==0}">Người Dùng</c:if>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <td class="px-4 py-3 text-xs">
                                                    <c:if test="${fn:contains(show.gioiTinh,'nam')}"> <span
                                                    ...
                                                    <c:if test="${fn:contains(show.gioiTinh,'nu')}"> <span
                                                            class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700"
                                                            >
                                                            ${show.gioiTinh}
                                                        </span> </c:if>
                                                    <c:if test="${fn:contains(show.gioiTinh,'khac')}"> <span
                                                            class="px-2 py-1 font-semibold leading-tight text-purple-700 bg-purple-100 rounded-full dark:text-purple-100 dark:bg-red-700"
                                                            >
                                                            ${show.gioiTinh}
                                                        </span> </c:if>
                                                    </td>
                                                ...
                                                <td class="px-4 py-3 text-xs">
                                                    ...
                                                    <span
                                                        class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-700"
                                                        >
                                                        <a href="#" onclick="showMess(${show.id})">Xóa id ${show.id}</a>
