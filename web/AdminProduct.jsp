<%-- 
    ...
    Created on : Oct 29, 2021, 3:08:49 PM
    Author     : nguye
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            function showMess(id) {
                var option = confirm('Bạn muốn xóa sản phẩm này?');
                if (option === true) {
                    ...
                    <ul class="mt-6">
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Quản Lí Người Dùng</span>
                            </a>
                        </li>
                    </ul>
                    <ul>
                    ...
                    <div class="container grid px-6 mx-auto">
                        ...
                        <a
                            ...
                            <div class="flex items-center">
                                ...
                                <span>Click vào để xem trang Sản Phẩm</span>
                            </div>
                            <span>Đi đến &RightArrow;</span>
                        </a>
                        ...
                        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3 text-xs">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                                        <fmt:formatNumber type="number" maxFractionDigits="0" value="${show.giatien}"></fmt:formatNumber>
                                                    </span>
                                                </td>
                                                <td class="px-4 py-3 text-sm">
                                                    ${show.mota}
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center space-x-4 text-sm">
                                                        <a href="UpdateProduct?sid=${show.id}">
                                                        ...
                                                        <button
                                                            ...
                                                            aria-label="Delete" onclick="showMess(${show.id})"
                                                            >
                                                            <svg
                                                                class="w-5 h-5"
                                                                aria-hidden="true"
                            ...
                            <form action="CreateProduct" method="GET">
                                <table class="w-full whitespace-no-wrap">
                                    <h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300"> Thêm một sản phẩm </h4>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td>
                                            <label class="left-0 text-sm">
                                                ...
                                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                       name="ten" type="text" placeholder="ví dụ: Bánh Tráng Trộn" style="background-color: graytext" />
                                            </label>
                                        </td>
                                        <td>
                                            <label class="left-0 text-sm">
                                                ...
                                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                       name="anh" type="text" placeholder="Link Hình" style="background-color: graytext" />
                                            </label>
                                        </td>
                                    </tr>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td>
                                            <label class="left-0 text-sm">
                                                <span class="text-gray-700 dark:text-gray-400">Giá tiền</span>
                                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                       name="giatien" type="text" placeholder="ví dụ: 5000" style="background-color: graytext" />
                                            </label>
                                        </td>
                                        <td>
                                            <label class="left-0 text-sm">
                                                <span class="text-gray-700 dark:text-gray-400">Tùy chỉnh</span>
                                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                       name="mota" type="text" placeholder="Tùy chỉnh" style="background-color: graytext"/>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-gray-700 dark:text-gray-400  form-check-label">
                                            <label class="block text-sm">
                                                <span class="text-gray-700 dark:text-gray-400">Thuộc tính</span>
                                                <span><br></span>
                                            </label>
                                            <label class="inline-flex text-sm text-gray-700 dark:text-gray-400 form-check-label">
                                                <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                                       name ="thuoctinh" class="form-check-input" type="radio" value="Ăn Chính">  Ăn chính</span>
                                            </label>
                                            <label class="inline-flex text-sm text-gray-700 dark:text-gray-400">
                                                <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                                       name ="thuoctinh" class="form-check-input" type="radio" value="Ăn Vặt"> Ăn vặt</span>
                                            </label>
                                            <label class="inline-flex text-sm text-gray-700 dark:text-gray-400">
                                                <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                                       name ="thuoctinh" class="form-check-input" type="radio" value="Tráng Miệng">  Tráng miệng</span>
                                            </label>
                                        </td>
                                    </tr> 
                                </table><br>
