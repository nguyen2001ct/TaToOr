<%-- 
    Document   : Watting
    Created on : 10/11/2021, 11:41:34 AM
    ...
    <body>
        ...
        <section class="contact spad">
            <div class="container center">
                ...
                <a class="center" href="index.jsp">
                    <i class="fa fa-truck fa-5x" aria-hidden="true" style="color:orange;font-size:380px;"></i>
                    <h class="breadcrumb__text font-weight-bold" style="font-size:35px;" >Đơn hàng của bạn đang được xử lý...</h>
                    
                </a>
               
                <a class="center">
                    <h class="breadcrumb__text font-weight-bold" style="font-size:40px;" >Bấm vào biểu tượng để quay lại trang chủ.</h>
                </a>
