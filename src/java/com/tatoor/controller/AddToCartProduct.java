 ...
 * @author MACBOOK PRO
 */
@WebServlet(name = "AddToCartProduct", urlPatterns = {"/AddToCartProduct"})
public class AddToCartProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAO dao = new DAO();
            String SanPham_id = request.getParameter("sid");
